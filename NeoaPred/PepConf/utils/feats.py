...
from NeoaPred.PepConf.data import protein
import NeoaPred.PepConf.data.residue_constants as rc
...
def atom14_to_atom37(atom14, batch):
    ...
    tmp = batch["atom37_atom_exists"][..., None].to(atom37_data.device)
    atom37_data = atom37_data * tmp

...
import numpy as np
import torch
from NeoaPred.PepConf.data import input_pipeline
...
def np_example_to_features(
    ...
    cfg, feature_names = make_data_config(config, mode=mode, num_res=num_res, crop_size=crop_size)

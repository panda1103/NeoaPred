...
###
from NeoaPred.masif_tools.default_config.global_vars import epsilon as eps
...
def compute_normal_weight(vertex, face):

    """
    Modified form the function <compute_normal>.
    """

...
# Creation Date and Time:  Fri May 29 16:20:49 2020
...
Vnm_tstop: stopping timer 27 (Setup timer).  CPU TIME = 1.373400e-02
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: fine problem setup).  CPU TIME = 1.128000e-02
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: coarse problem setup).  CPU TIME = 5.952900e-02
Vnm_tstart: starting timer 30 (Vmgdrv2: solve)..
Vnm_tstop: stopping timer 40 (MG iteration).  CPU TIME = 1.049310e-01
Vprtstp: iteration = 0
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: solve).  CPU TIME = 4.254860e-01
Vnm_tstop: stopping timer 28 (Solver timer).  CPU TIME = 5.074860e-01
...
Vnm_tstop: stopping timer 30 (Force timer).  CPU TIME = 5.002000e-03
Vnm_tstart: starting timer 27 (Setup timer)..
Setting up PBE object...
Vpbe_ctor2:  solute radius = 4
Vpbe_ctor2:  solute dimensions = 8 x 4 x 4
...
Vpmg_fillco:  filling boundary arrays
Vpmg_fillco:  done filling boundary arrays
Vnm_tstop: stopping timer 27 (Setup timer).  CPU TIME = 1.630500e-02
Vnm_tstart: starting timer 28 (Solver timer)..
Vnm_tstart: starting timer 30 (Vmgdrv2: fine problem setup)..
Vbuildops: Fine: (065, 065, 065)
Vbuildops: Operator stencil (lev, numdia) = (1, 4)
Vnm_tstop: stopping timer 30 (Vmgdrv2: fine problem setup).  CPU TIME = 1.064600e-02
Vnm_tstart: starting timer 30 (Vmgdrv2: coarse problem setup)..
Vbuildops: Galer: (033, 033, 033)
Vbuildops: Galer: (017, 017, 017)
Vbuildops: Galer: (009, 009, 009)
Vbuildops: Galer: (005, 005, 005)
Vnm_tstop: stopping timer 30 (Vmgdrv2: coarse problem setup).  CPU TIME = 6.020100e-02
Vnm_tstart: starting timer 30 (Vmgdrv2: solve)..
Vnm_tstop: stopping timer 40 (MG iteration).  CPU TIME = 6.504240e-01
Vprtstp: iteration = 0
Vprtstp: relative residual = 1.000000e+00
Vprtstp: contraction number = 1.000000e+00
Vprtstp: iteration = 1
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: solve).  CPU TIME = 3.862730e-01
Vnm_tstop: stopping timer 28 (Solver timer).  CPU TIME = 4.715410e-01
Vpmg_setPart:  lower corner = (-6.72, -6.72, -6.72)
Vpmg_setPart:  upper corner = (6.72, 6.72, 6.72)
Vpmg_setPart:  actual minima = (-6.72, -6.72, -6.72)
Vpmg_setPart:  actual maxima = (6.72, 6.72, 6.72)
...
forceAPOL: atom surf: Time elapsed: 0.001029
forceAPOL: Time elapsed: 3.620012
Vacc_SASA: Time elapsed: 0.000001
initAPOL: Time elapsed: 10.479469
...
Vcom_reduce:  Not compiled with MPI, doing simple copy.
Vcom_reduce:  Not compiled with MPI, doing simple copy.
Vnm_tstop: stopping timer 26 (APBS WALL CLOCK).  CPU TIME = 1.152293e+01
